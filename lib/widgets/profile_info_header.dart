    ...
    return Center(
      child: Column(
        children: [
            ...
            child: CircleAvatar(
              ...
              child: Stack(
                ...
                children: [
                  CircleAvatar(
                    radius: 55,
                    key: ValueKey<String?>(profileImagePath ?? DateTime.now().toString()),
                    backgroundColor: Colors.grey[300],
                    backgroundImage: profileImagePath != null && File(profileImagePath!).existsSync()
                        ? FileImage(File(profileImagePath!)) as ImageProvider
                        : const AssetImage("assets/images/placeholder_profile.png"), // Sediakan placeholder
                  ),
                  Positioned(
                    bottom: 0, right: 0,
                    child: Container(
          ...
          Text(usernameDisplay, style: Theme.of(context).textTheme.headlineSmall), // Contoh menampilkan username
